...
public class Server implements HttpHandler {
    private static Task[] predefinedTasks = { new Task("1","Create markup", true), new Task("2","Learn JavaScript", true), new Task("3","Write The Chat !", false) };
    ...
    private void doPost(HttpExchange httpExchange) throws Exception {
        try {
            ...
            System.err.println("Invalid task: " + httpExchange.getRequestBody() + " " + e.getMessage());
